    ...
    <div class="checkout-card">
            ...
            <div class="order-info">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <span class="status-badge status-<?= strtolower($order['payStatus']) ?>"><?= htmlspecialchars($order['payStatus']) ?></span>
                    </div>
                    <div class="info-item">
        ...
        <?php if ($order['payMethod'] === 'COD'): ?>
            <div class="cod-notice">
                ...
                <p><strong>Amount to pay: RM <?= number_format($order['total'], 2) ?></strong></p>
            </div>
        <?php endif; ?>
    </div>
</main>
